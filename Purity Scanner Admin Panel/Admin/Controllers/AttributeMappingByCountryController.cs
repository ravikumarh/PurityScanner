...
{
    public class AttributeMappingByCountryController : Controller
    {
        ...
        public ActionResult ListProdAttriCountryMapping()
        {
            try
            {
                ...
                if (objControl != null)
                {
                    if (!string.IsNullOrEmpty(objControl.FilterCountryCode))
                    {
                        lstProdAttriMapping = objOperation.getAllProdAttriMappingByCountryIDProductID(objControl.FilterCountryCode);
